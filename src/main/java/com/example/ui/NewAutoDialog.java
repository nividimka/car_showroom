...
public class NewAutoDialog extends JDialog {
    ...
    public NewAutoDialog() {
        $$$setupUI$$$();
        setTitle("Добавление нового автомобиля");
    ...
    private void initItems() {
        ...
        for (CarNumberModel model : carNumbers) {
        ...
        for (ManufacturerModel model : manufacturers) {
    ...
    private void onOK() {
        ...
        CarNumberModel carNumberModel = comboBox1.getItemAt(comboBox1.getSelectedIndex());
        if (carService.isNumberAlreadyAssigned(carNumberModel)) {
            JOptionPane.showMessageDialog(this, "Этот номер привязан уже к другой машине", "Ошибка", JOptionPane.INFORMATION_MESSAGE);
            return;
        }
        ...
        long carId = carService.newCar(name.getText(),
        ...
        if (carId == -1) {
            JOptionPane.showMessageDialog(this, "Не удалось создать машину", "Ошибка", JOptionPane.INFORMATION_MESSAGE);
            return;
        }
        if (onCarAddListener != null) {
            onCarAddListener.onAdd(carService.getCar(carId));
        }
        JOptionPane.showMessageDialog(this, "Автомобиль успешно добавлен!", "Успешно", JOptionPane.INFORMATION_MESSAGE);
        onCancel();
    }
