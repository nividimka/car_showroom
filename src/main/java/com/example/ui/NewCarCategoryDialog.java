...
public class NewCarCategoryDialog extends JDialog {
...
//        datePickerContainer.add(datePicker);
    ...
    private void $$$setupUI$$$() {
        ...
        label1.setText("Название категории");
    ...
    public interface OnAddListener {
        public void onAdd(CategoryModel carModel);
    }
    ...
    private void onOK() {
        ...
        boolean res = carService.newCarCategory(number.getText());
        if (!res) {
            JOptionPane.showMessageDialog(this, "Категория " + number.getText() + ": уже существует", "Ошибка", JOptionPane.INFORMATION_MESSAGE);
            return;
        }
        if (onAddListener != null) {
            onAddListener.onAdd(carService.getCarCategory(number.getText()));
        }
        JOptionPane.showMessageDialog(this, "Категория добавлена!", "Успешно", JOptionPane.INFORMATION_MESSAGE);
        onCancel();
    }
